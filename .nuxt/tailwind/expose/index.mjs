...
const config = { theme, corePlugins, plugins, content, darkMode, presets, prefix, important, separator, safelist, blocklist, variants }
export { config as default, theme, corePlugins, plugins, content, darkMode, presets, prefix, important, separator, safelist, blocklist, variants }